      ...
      html: `
        <div style="max-width:520px;margin:auto;border-radius:8px;border:1px solid #e0e0e0;background:#fff;overflow:hidden;font-family:sans-serif;">
          <div style="background:#00B9F1;padding:24px 0;text-align:center;">
            ...
            <h1 style="color:#fff;margin:0;font-size:2rem;">Welcome to Adesola Plastics Store!</h1>
          </div>
          <div style="padding:32px 24px 24px 24px;">
            ...
            <a href="https://adesolaplasticsstore.com.ng" style="display:inline-block;margin:18px 0 0 0;padding:12px 28px;background:#00B9F1;color:#fff;text-decoration:none;border-radius:4px;font-weight:bold;">Visit Our Website</a>
            ...
            <p style="margin-top:32px;color:#888;font-size:0.95rem;">Best regards,<br/>Adesola Plastics Store</p>
          </div>
        </div>
      `
    });
